...
function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0a0a0f] px-4 py-12 font-sans selection:bg-violet-500 selection:text-white relative overflow-hidden">
      ...
      />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] -z-10 rounded-full bg-violet-700/[0.05] blur-[80px]" />

      <div className="relative w-full max-w-md rounded-2xl border border-white/[0.06] bg-[#111118] p-8 shadow-2xl shadow-black/80">
        ...
        <div className="grid grid-cols-2 gap-3 mb-5">
          <button 
            ...
            className="flex items-center justify-center gap-2 rounded-xl bg-white/[0.02] border border-white/[0.06] hover:border-white/20 hover:bg-white/[0.04] px-4 py-2.5 text-[13px] font-medium text-white/80 transition-colors cursor-pointer"
          >
        ...
        <div className="relative flex py-2 items-center mb-4">
          ...
          <span className="flex-shrink mx-3 text-[11px] font-medium uppercase tracking-wider text-white/20">or continue with</span>
          <div className="flex-grow border-t border-white/[0.04]"></div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-xl bg-white/[0.03] border border-white/[0.08] px-4 py-3 text-[13px] text-white placeholder-white/20 outline-none focus:outline-none focus:border-violet-500 focus:bg-white/[0.05] transition-colors duration-200"
            />
          </div>
